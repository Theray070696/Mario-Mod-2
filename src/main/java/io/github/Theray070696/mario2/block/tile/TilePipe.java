...
public class TilePipe extends TileEntity
{
    ...
    public TilePipe getMasterTile()
    {
        ...
        {
            if(world.getTileEntity(new BlockPos(this.masterX, this.masterY, this.masterZ)) instanceof TilePipe)
            {
                return (TilePipe) world.getTileEntity(new BlockPos(this.masterX, this.masterY, this.masterZ));
            }
        }
    ...
    public BlockPipe getMasterBlock()
    {
        if(this.isMaster())
        {
            return (BlockPipe) world.getBlockState(pos).getBlock();
        } else if(this.hasMaster())
        {
            if(world.getBlockState(new BlockPos(this.masterX, this.masterY, this.masterZ)).getBlock() instanceof BlockPipe)
            {
                return (BlockPipe) world.getBlockState(new BlockPos(this.masterX, this.masterY, this.masterZ)).getBlock();
            }
        }
