...
public class BlockBeanstalk extends BlockMario
{
    ...
    {
        if(world.getBlockState(pos).getBlock() instanceof BlockBeanstalk)
        {
    ...
    {
        return state.withProperty(ISTOP, !(world.getBlockState(pos.up()).getBlock() instanceof BlockBeanstalk));
    }
}
