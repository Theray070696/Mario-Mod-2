 ...
 */
public class BiomeMarioForest extends BiomeForest
{
    public BiomeMarioForest(String registryName)
    {
        this(new BiomeProperties("Mario Forest").setBaseBiome("Forest").setTemperature(0.7F).setRainfall(0.8F), registryName);
    }

    public BiomeMarioForest(BiomeProperties properties, String registryName)
    {
        super(BiomeForest.Type.NORMAL, properties);
