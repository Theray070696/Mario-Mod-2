...
import io.github.Theray070696.mariodeath.world.genlayer.MarioGenLayer;
 ...
 */
public class WorldChunkManagerMario extends WorldChunkManager
{
    ...
    public WorldChunkManagerMario(long seed, WorldType worldType)
    {
        this();
        GenLayer[] agenlayer = MarioGenLayer.makeTheWorld(seed, worldType);
        agenlayer = getModdedBiomeGenerators(worldType, seed, agenlayer);
        this.genBiomes = agenlayer[0];
        this.biomeIndexLayer = agenlayer[1];
    }

    public WorldChunkManagerMario(World world)
    {
