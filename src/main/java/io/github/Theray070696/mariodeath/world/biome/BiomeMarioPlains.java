...
public class BiomeMarioPlains extends BiomePlains
{
    public BiomeMarioPlains()
    {
        ...
        this.topBlock = ModBlocks.blockGround.getDefaultState();
        this.fillerBlock = ModBlocks.blockGround.getDefaultState();
        ...
        for(int y = 255; y >= 0; --y)
        {
            ...
            } else
            {
                ...
                } else if(blockState.getBlock() == Blocks.STONE)
                {
                    ...
                    {
                        // Replace all stone with Underground Ground Blocks
                        chunkPrimerIn.setBlockState(localZ, y, localX, fillerBlockState);
                    }
                }
            }
