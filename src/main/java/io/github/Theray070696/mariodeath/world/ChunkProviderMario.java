...
public class ChunkProviderMario implements IChunkProvider
{
    ...
    /**
     * Holds Village Generator (TEMPORARY UNTIL TOAD TOWNS ARE IMPLEMENTED)
     */
    ...
    public ChunkProviderMario(World world, long seed)
    {
        this.worldObj = world;
                    ...
                    for(int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for(int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for(int k3 = 0; k3 < 4; ++k3)
                            {
                                if((d15 += d16) > 0.0D)
                                {
                                    p_147424_3_[j3 += short1] = ModBlocks.blockGround;
                                } else if(k2 * 8 + l2 < b0)
                                {
    ...
    public void replaceBlocksForBiome(int p_147422_1_, int p_147422_2_, Block[] p_147422_3_, byte[] p_147422_4_, BiomeGenBase[] p_147422_5_)
    {
        ...
        for(int k = 0; k < 16; ++k)
        {
            for(int l = 0; l < 16; ++l)
            {
                ModBiomes biomegenbase = (ModBiomes) p_147422_5_[l + k * 16];
    ...
    public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
    {
        ...
        if(biomegenbase != BiomeGenBase.desert && biomegenbase != BiomeGenBase.desertHills && !flag && this.rand.nextInt(4) == 0 && TerrainGen.populate(p_73153_1_, worldObj, rand, p_73153_2_, p_73153_3_, flag, LAKE))
        {
        ...
        {
            //SpawnerAnimals.performWorldGenSpawning(this.worldObj, biomegenbase, k + 8, l + 8, 16, 16, this.rand); // This will be swapped for enemy spawning, Goomba, Koopa, etc.
        }
        k += 8;
        l += 8;
    ...
    /**
     * I THINK this is for Eyes of Ender to locate a Stronghold.
     */
